...
WebUI.setText(findTestObject('Page_Gmail/input_to continue to Gmail_identifier'), 'mike08e99gatling@gmail.com')

WebUI.click(findTestObject('Page_Gmail/span_Next'))

WebUI.delay(5)

WebUI.setEncryptedText(findTestObject('Page_Gmail/input_Too many failed attempts_password'), 'RDYJ277246')
...
for (def index : (0..22)) {
    ...
    WebUI.setText(findTestObject('Page_Create your own - IFTTT/textarea_httppinterestcomjanewfeedrss'), 'https://www.pinterest.com/dakotaschule/hair-ideas.rss')
